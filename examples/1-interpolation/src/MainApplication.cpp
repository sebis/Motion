...
namespace Interpolation
{
	...
	void MainApplication::setScene(int scene)
	{
		...
		if (scene == 0)
		{
			...
			KeyframeAnimator<glm::vec3> * animator = new KeyframeAnimator<glm::vec3>(obj, interpolator, obj->transform().position(), ORIENT | CONNECT);
		...
		else if (scene == 1)
		{
			...
			Interpolator<glm::vec3> * interpolator = new LinearInterpolator<glm::vec3>;
			KeyframeAnimator<glm::vec3> * animator = new KeyframeAnimator<glm::vec3>(obj, interpolator, obj->transform().position(), ORIENT | CONNECT | REPARAM);
		...
		else if (scene == 4)
		{
			...
			animator->addKeyframe(0.0f, glm::vec3(0.0f, 0.0f, 0.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(2000.0f, glm::vec3(3.5f, 0.0f, 4.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(3000.0f, glm::vec3(8.0f, 0.0f, 2.5f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(4000.0f, glm::vec3(7.0f, 0.0f, 0.5f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(7000.0f, glm::vec3(5.0f, 0.0f, -0.5f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(13000.0f, glm::vec3(-0.5f, 3.0f, 6.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(15000.0f, glm::vec3(-9.0f, 0.0f, 3.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(16000.0f, glm::vec3(-6.0f, 2.0f, -8.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(18000.0f, glm::vec3(-3.0f, 0.0f, -8.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(20000.0f, glm::vec3(-4.0f, 0.0f, -13.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(21000.0f, glm::vec3(-1.0f, 0.0f, -12.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(23000.0f, glm::vec3(4.0f, 0.0f, -6.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
			animator->addKeyframe(24000.0f, glm::vec3(0.0f, 0.0f, 0.0f), (float)r.rand11(), (float)r.rand11(), (float)r.rand11());
		...
		else if (scene == 5)
		{
			...
			Interpolator<glm::vec3> * interpolator = new LinearInterpolator<glm::vec3>;
			KeyframeAnimator<glm::vec3> * animator = new KeyframeAnimator<glm::vec3>(obj, interpolator, obj->transform().rotation(), 0);
			animator->addKeyframe(0.0f, glm::vec3(0.0f, 0.0f, 0.0f));
		...
		else if (scene == 6)
		{
			...
			{ // First object using SLERP
				...
				KeyframeAnimator<glm::quat> * animator = new KeyframeAnimator<glm::quat>(obj, interpolator, obj->transform().quaternion(), CONNECT);
			...
			{ // Second object using Bezier-SLERP
				...
				KeyframeAnimator<glm::quat> * animator = new KeyframeAnimator<glm::quat>(obj, interpolator, obj->transform().quaternion(), 0);
